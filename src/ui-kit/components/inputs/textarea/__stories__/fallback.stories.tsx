...
import TextAreaFallback from "@/ui-kit/components/inputs/textarea/fallback/fallback";


export default {
  title: "inputs/Textarea",
  component: TextAreaFallback,
} as ComponentMeta<typeof TextAreaFallback>;


const FallbackTemplate: ComponentStory<typeof TextAreaFallback> = (args) => <TextAreaFallback {...args}/>;
