...
export default {
  ...
  component: DropdownFallback,
} as ComponentMeta<typeof DropdownFallback>;


const FallbackTemplate: ComponentStory<typeof DropdownFallback> = (args) => <DropdownFallback {...args}/>;
