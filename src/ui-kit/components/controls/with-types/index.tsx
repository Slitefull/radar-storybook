...
type SelectVariants = "searchable" | "multi";
...
const DropdownWithTypes: FC<SelectWithTypesProps> = memo((
  ...
  const getSelectType = (types: SelectVariants[]): SelectTypes => {
  ...
  const customStyles: StylesConfig<Option, true> = {
    control: (provided, { isFocused, selectProps }) => ({
      ...
      border: isFocused ? `1px solid ${PRIMARY_60}` : `1px solid ${NEUTRAL_30}`,
    ...
    option: (provided, { isSelected }) => ({
      ...
      color: isSelected ? PRIMARY_50 : NEUTRAL_70,
    }),
    container: (provided) => ({
      ...provided,
      width: "100%",
