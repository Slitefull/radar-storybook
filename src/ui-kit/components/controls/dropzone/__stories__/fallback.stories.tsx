...
import DropzoneFallback from "../fallback";


export default {
  title: "inputs/Dropzone",
  component: DropzoneFallback,
} as ComponentMeta<typeof DropzoneFallback>;


const FallbackTemplate: ComponentStory<typeof DropzoneFallback> = (args) => <DropzoneFallback {...args}/>;
