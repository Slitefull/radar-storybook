...
import RoundedBannerFallback from "../fallback";


export default {
  title: "Banners/Rounded",
  component: RoundedBannerFallback,
} as ComponentMeta<typeof RoundedBannerFallback>;


const FallbackTemplate: ComponentStory<typeof RoundedBannerFallback> = (args) => <RoundedBannerFallback {...args}/>;
