...
import { BLACK, PRIMARY_60 } from "@/ui-kit/constants/colors";
      ...
      >
        <g opacity="0.6">
          ...
          11.5833V5.16667C1.77148 4.85725 1.89595 4.5605 2.11749 4.34171C2.33904 4.12292 2.63952 4 2.95284 4H6.4969"
            stroke={isHovered ? PRIMARY_60 : color}
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path d="M8.85938 2.25H12.4034V5.75" stroke={isHovered ? PRIMARY_60 : color} strokeLinecap="round"
                strokeLinejoin="round"/>
          <path d="M5.90625 8.66667L12.4037 2.25" stroke={isHovered ? PRIMARY_60 : color} strokeLinecap="round"
                strokeLinejoin="round"/>
        </g>
      </svg>
    </div>
