...
import CardsSectionFallback from "@/pages/monitor-changes/components/cards-section/fallback";
import MonitorTableFallback from "@/pages/monitor-changes/components/table/fallback";
