...
import Switcher from "@/ui-kit/components/inputs/switcher";
import Dropdown from "@/ui-kit/components/dropdowns/dropdown";
import SwiperPrevButton from "@/pages/monitor-changes/components/swiper-prev-button";
import SwiperNextButton from "@/pages/monitor-changes/components/swiper-next-button";
